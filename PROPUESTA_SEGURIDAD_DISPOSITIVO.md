...
- **Fase P2 (sin esquema).** Vínculo polimórfico en pasos y tareas, con normalización compatible hacia atrás. "Vincular información protegida" en el editor. Grafo, `ReferenciadoPor` e impacto antes de eliminar. Hereda de P1 el cierre del hueco de los campos protegidos huérfanos: al sumar `campos_protegidos` al grafo, el diálogo de eliminación de un equipo avisa "Se usa en N datos protegidos" igual que ya hace con el resto de vínculos.
