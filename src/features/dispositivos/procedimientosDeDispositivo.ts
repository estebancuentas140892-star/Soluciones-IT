...
// para no repetirlos. `dispositivo` (hallazgo H6, opcional) refina
// ademas por `aplicaA`: sin el, o si el articulo no restringe marca ni
// modelo, se comporta igual que antes de H6. Logica pura para poder
