...
// El gesto de la acción en un paso de guía: entrar, abrir o seleccionar
// (encargo del 2026-09-22, sección 4, azul).
export function CursorClick(props: IconoProps) {
  return (
    <IconoBase {...props}>
...
// Grafo de nodos: la topología de la red, la fila de Más >
// Infraestructura (tarea 257). No se reutiliza TreeStructure, que en
// toda la app es la guía con preguntas (buscador, Resolver, ficha del
// equipo), y en Más las dos filas quedan a la vista a la vez (R24: un
// icono, un significado).
export function Graph(props: IconoProps) {
  return (
    <IconoBase {...props}>
...
// Los requisitos de una guía: lo que tiene que estar listo antes del
// paso 1 (encargo del 2026-09-22, sección 7).
...
// Caja: las herramientas de inventario (tarea 268), la puerta única de
// Importar equipos, Etiquetas QR y los datos por ordenar. Copiado del SVG
// de Phosphor 2.1.1 (regular), como `Graph`. No se reutilizan `QrCode` ni
// `UploadSimple`: cada uno es SOLO una de las herramientas (R24).
export function Package(props: IconoProps) {
  return (
    <IconoBase {...props}>
...
// Tarea 268: el estado de un equipo (Operativo, Disponible, En
// mantenimiento...), en la fila "Estados escritos a mano" de Herramientas
// de inventario. Copiado del SVG de Phosphor 2.1.1 (regular). No se
// reutiliza `Monitor`, que es la pestaña Equipos (R24).
export function Pulse(props: IconoProps) {
  return (
    <IconoBase {...props}>
...
// Variante rellena: la pestaña Resolver activa (encargo del 2026-09-22).
export function WrenchFill(props: IconoProps) {
  return (
    <IconoBase {...props}>
