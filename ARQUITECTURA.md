...
- Los pasos de un procedimiento de Soluciones pueden vincular una credencial. Ver los datos desde el paso exige exactamente lo mismo que en la sección Notas: permiso puede_ver_boveda y contraseña maestra (con desbloqueo en línea y el mismo autobloqueo). Quien no está autorizado solo ve el título de referencia del vínculo.
