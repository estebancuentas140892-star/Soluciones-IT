...
- **"Falla"** sale del foco y deja un aviso ámbar sobre el paso completo ("Marcaste una falla en «...»") con enlace a la solución vinculada del paso si la tiene, y un "Quitar el aviso". **No completa nada ni toca el progreso**: la pregunta de error normal ("¿Ocurrió algún error?") sí completa el paso al resolverse, y en foco puede haber tareas sin marcar.
