...
- **Cada tipo de tarea tiene sus propios controles** (tarea 234, secciones 5 y 6 del encargo del 2026-09-09). Una **acción** dice "Marcar hecha" y su salida es "Falla". Una **comprobación** dice "Sí, lo comprobé" y su salida es "No se cumple". Una **decisión** lleva la pastilla "Decisión", la pregunta como titular y **dos respuestas**: "Sí" y "No, abrir «destino»", que despliega el destino ahí mismo bajo el rótulo "Si esto falla"; terminarlo deja la decisión respondida y al técnico en el mismo punto, y "Volver a la pregunta" deshace la respuesta. Sin destino configurado, "No, continuar" registra la decisión igual. Antes las tres usaban el mismo "Marcar hecha".
- **El botón grande también cierra el paso** (tarea 217): mientras queden tareas dice "Marcar hecha"; cuando ya no queda ninguna pasa a decir lo mismo que la vista completa ("Paso hecho · ir al 4"), con la razón escrita encima si todavía no se puede. Antes había que salir al paso entero para avanzar, lo que con la ejecución por defecto habría dejado la pantalla sin salida. Con todo marcado aparece un **"Desmarcar"** de 44 px junto a la pastilla de tarea, para corregirse sin salir.
