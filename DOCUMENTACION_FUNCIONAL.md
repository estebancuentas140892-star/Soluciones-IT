...
4. **Borradores coincidentes** (2026-09-20, tarea 248), **debajo de todo lo anterior y siempre que haya búsqueda**: los artículos en `borrador` (ni publicados, ni obsoletos, ni eliminados) que coinciden con lo escrito, en **su propio bloque**, con su rótulo, su conteo y una línea que lo dice sin rodeos: "Todavía no son procedimientos del equipo: no salen en los resultados hasta que se publiquen". Cada fila: **título** con el término resaltado, la pastilla **"Borrador"**, la **categoría** y la acción **"Revisar borrador"**, que abre el **editor** del artículo (`/soluciones/:categoriaId/:articuloId/editar`), no su ejecución. Se ven **tres** y el resto entra con "Ver los otros N"; al lado, "Ver todos en Guías". **Nunca se mezclan con los resultados oficiales**, y el borrador **no entra en el índice** (`documentosDeBusqueda` sigue indexando solo lo publicado).
