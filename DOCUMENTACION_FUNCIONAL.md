...
- **El foco se ve en el borde de la caja** (segunda pasada del 2026-09-17): con el campo enfocado el borde pasa al acento, igual que con texto escrito, y el anillo global de foco no se dibuja dentro (se veían dos marcos, uno rectangular dentro del redondeado).
