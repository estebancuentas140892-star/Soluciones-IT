...
Archivo `src/features/soluciones/ArticuloForm.tsx`. Editor a pantalla completa con **cuatro pestañas** de 52 px dentro de un contenedor pegajoso. Cambiar de pestaña no pierde nada, y desde la tarea 219 **tampoco lo pierde una interrupción** (ver abajo). Cada pestaña marca con un punto si tiene algo pendiente. Barra inferior con la **barra de añadir** del editor de pasos (solo en la pestaña Pasos, ver 7.2.1), **completitud %** (10 señales), lista de **sugerencias** tocables (cada una lleva a su pestaña), y dos acciones de 56 px: **"Guardar"** y, a su izquierda, **"Vista previa"** o **"Probar"**.
