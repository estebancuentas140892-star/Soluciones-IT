...
- **"Ver el paso entero" es la excepción, y se recuerda** (tarea 217, hallazgos **G-16** y **G-17**). El control de 44 px de la cabecera lleva a la vista de paso completo, y **la elección queda guardada** en este dispositivo: salir a la Bóveda a buscar una clave y volver ya no devuelve al técnico a una vista que él no eligió. Desde la vista completa se vuelve con **"Volver a una tarea a la vez"**, que ocupa la fila de 44 px donde antes estaba el botón "Foco". La única excepción que no toca la preferencia es **declarar una falla**: sus cuatro salidas viven en el paso completo, así que se muestra ese paso y solo ese; al pasar al siguiente se vuelve solo a como el técnico trabaja.
...
- **La barra tiene dos filas** (tarea 215): arriba, a 44 px, lo que no es trabajo ("Atrás" reducido a icono y, desde la tarea 217, **"Volver a una tarea a la vez"**, que está siempre, también en los pasos sin tareas); abajo, la fila que cae bajo el pulgar, a **56 px**, **"Falla"** y la acción dominante. En una sola fila los cuatro controles dejaban la acción dominante en 88 px sobre una pantalla de 360, recortada a "Paso hecho · i...". **Y esta barra ya no desaparece:** la pregunta de error la reemplazaba, y el layout saltaba.
