...
- **Dónde:** `BarraSuperior` (avatar de la ranura de cuenta), `PantallaMas` (fila de perfil del grupo "Configuración", que se llamaba "Mi cuenta" hasta la tarea 257).
...
- **Dónde:** `PantallaMas` (grupo "Configuración", "Mi cuenta" hasta la tarea 257) y `ActualizacionDisponible` (global).
