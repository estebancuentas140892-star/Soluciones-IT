...
- **Dónde:** `PantallaMas` (todas sus filas menos Mis favoritos, que se despliega, y Ajustes, que lleva el avatar) y `inventario/HerramientasInventarioPage`.
