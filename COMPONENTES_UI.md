...
### 3.8i `soluciones/ModoFoco`
- **Propósito:** modo de ejecución de **una tarea a la vez** (tarea 211, tablero `6d`). Es la oportunidad grande que señala el Paso 6: todo el sistema está construido alrededor del PASO, pero frente al equipo, con una mano y guantes, la unidad real de trabajo es la TAREA. El técnico veía tres tareas, dos avisos y una imagen a la vez y tenía que encontrar cuál le tocaba.
- **Props:** `{ paso, indicePaso, totalPasos, tituloPaso, instruccionesHechas, onAlternarTarea, onSalir, onFalla }`.
